//Model do 2 podpunktu zadania.
//p2.props - w³asnoœci do sprawdzenia w tym modelu
dtmc
...
[] s=24 -> 1 : (s'=26) & (d2'=5);
[] s=25 -> 1 : (s'=26) & (d2'=6);
[] s=26 & (d1 = d2 - 1) & b < 10 -> 1 : (s'=0) & (b'=b+2);
[] s=26 & d1 < d2 -1 & b > -10 -> 1  : (s'=0) & (b'=b-1);
[] s=26 & d2 = d1 - 1 & b > -10 -> 1  : (s'=0) & (b'=b-2);
[] s=26 & d2 < d1 -1  & b < 10 -> 1 : (s'=0) & (b'=b+1);
[] s=26 & d1 = d2 -> 1 : (s'=0);
[] s=27 -> 1 : (s'=27);
